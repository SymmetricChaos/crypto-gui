...
macro_rules! simon64 {
    ($name:ident, $key_words:literal, $rounds:literal, $z_string:literal) => {
        ...
        crate::block_cipher_builders! {$name, u64}
...
crate::test_block_cipher!(
    test_64_96, Simon64_96::default().with_key([0x13, 0x12, 0x11, 0x10, 0x0b, 0x0a, 0x09, 0x08, 0x03, 0x02, 0x01, 0x00]),
    [0x6f, 0x72, 0x20, 0x67, 0x6e, 0x69, 0x6c, 0x63],
    [0x5c, 0xa2, 0xe2, 0x7f, 0x11, 0x1a, 0x8f, 0xc8];
    test_64_128, Simon64_128::default().with_key([0x1b, 0x1a, 0x19, 0x18, 0x13, 0x12, 0x11, 0x10, 0x0b, 0x0a, 0x09, 0x08, 0x03, 0x02, 0x01, 0x00]),
