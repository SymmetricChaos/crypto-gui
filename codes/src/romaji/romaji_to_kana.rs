...
use crate::romaji::tokenizer::Node;
...
pub static ROMAJI_TO_KANA: LazyLock<Node> = LazyLock::new(|| {
    Node {
        transitions: Some(vec![
                ...
                vec![
                    ...
                    Node::branch(
                        ...
                        vec![
                            ...
                            Node::branch('z', None, vec![Node::leaf('u', "っづ")]),
                        ],
                    ),
                    Node::branch(
                        'h',
                    ...
                    Node::branch('z', None, vec![Node::leaf('u', "づ")]),
                ],
            ),
            Node::branch(
                'f',
            ...
            Node::branch(
                ...
                vec![
                    ...
                    Node::leaf('o', "ぉ"),
                    Node::leaf('u', "ぅ"),
                    Node::branch('w', None, vec![Node::leaf('a', "ゎ")]),
                    Node::branch(
                        'y',
                        None,
                        vec![
                    ...
                    Node::branch(
                        ...
                        vec![
                            Node::leaf('u', "っ"),
                            Node::branch('s', None, vec![Node::leaf('u', "っ")]),
                        ],
                    ),
                ],
            ),
                ...
                vec![
                    ...
                    Node::branch(
                        ...
                        vec![
                            ...
                            Node::branch('s', None, vec![Node::leaf('u', "っつ")]),
                        ],
                    ),
                    Node::branch(
                        'y',
                    ...
                    Node::branch('s', None, vec![Node::leaf('u', "つ")]),
                ],
            ),
            Node::branch(
                'v',
            ...
            Node::branch(
                ...
                vec![
                    ...
                    Node::branch(
                        'y',
                        None,
                        vec![Node::leaf('i', "ゐ"), Node::leaf('e', "ゑ")],
                    ),
                    Node::branch(
                        'w',
                        None,
                        vec![
                            ...
                            Node::branch(
                                'y',
                                None,
                                vec![Node::leaf('i', "っゐ"), Node::leaf('e', "っゑ")],
                            ),
                        ],
                    ),
                ],
            ...
            Node::branch(
                ...
                vec![
                    ...
                    Node::branch(
                        'k',
                        None,
                        vec![Node::leaf('a', "ヵ"), Node::leaf('e', "ヶ")],
                    ),
                    Node::branch(
                        'y',
                        None,
