...
pub const WABUN_HALFBLOCK: [&str; 116] = [
    "▄▄▄ ▄▄▄ ▄ ▄▄▄ ▄▄▄",
    "▄ ▄▄▄",
    "▄ ▄ ▄▄▄",
    "▄▄▄ ▄ ▄▄▄ ▄▄▄ ▄▄▄",
...
lazy_static! {
    ...
    pub static ref WABUN_ASCII_MAP: BiMap<&'static str, &'static str> =
        bimap_from_iter(HIRAGANA.into_iter().zip(WABUN_ASCII.into_iter()));
    pub static ref WABUN_HALFBLOCK_MAP: BiMap<&'static str, &'static str> =
        bimap_from_iter(HIRAGANA.into_iter().zip(WABUN_HALFBLOCK.into_iter()));
    pub static ref WABUN_WORD_MAP: BiMap<&'static str, &'static str> =
        bimap_from_iter(HIRAGANA.into_iter().zip(WABUN_WORD.into_iter()));
}
