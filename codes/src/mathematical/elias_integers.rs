...
use utils::bits::{bits_from_str, bits_to_u32_le, Bit};
        ...
        loop {
            if let Some(b) = bits.next() {
                ...
                if b.is_zero() {
                    ...
                    out.push(bits_to_u32_le(&buffer));
                    // Clear buffer and counter
                    buffer.clear();
                    zero_ctr = 0;
                }
