...
mod tests {
    ...
    fn test_mix_bytes() {
        ...
        let reference_output = State512([
            [0x18, 0x0, 0x28, 0x30, 0x78, 0x60, 0x48, 0x50],
            [0x13, 0xb, 0x23, 0x3b, 0x73, 0x6b, 0x43, 0x5b],
            [0xa, 0x12, 0x3a, 0x22, 0x6a, 0x72, 0x5a, 0x42],
            [0x9, 0x11, 0x39, 0x21, 0x69, 0x71, 0x59, 0x41],
            [0x14, 0xc, 0x24, 0x3c, 0x74, 0x6c, 0x44, 0x5c],
            [0x1f, 0x7, 0x2f, 0x37, 0x7f, 0x67, 0x4f, 0x57],
            [0x6, 0x1e, 0x36, 0x2e, 0x66, 0x7e, 0x56, 0x4e],
            [0x5, 0x1d, 0x35, 0x2d, 0x65, 0x7d, 0x55, 0x4d],
        ]);
        mix_bytes_512(&mut array);
        assert_eq!(reference_output.0, array.0);
    }
}
