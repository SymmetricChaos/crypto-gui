...
impl HasherFrame for Md2Frame {
    fn ui(&mut self, ui: &mut egui::Ui, _errors: &mut String) {
        ...
        ui.monospace(
            "Text (UTF-8):  Hồ Chí Minh\nBytes:         48 e1 bb 93 43 68 c3 ad 4d 69 6e 68\nWith Padding:  48 e1 bb 93 43 68 c3 ad 4d 69 6e 68 02 02\nWith Checksum: 48 e1 bb 93 43 68 c3 ad 4d 69 6e 68 02 02 94 a4 ca 3e 82 dc 85 07 f9 cb 87 4b d4 41 91 ad",
        );
