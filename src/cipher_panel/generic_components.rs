...
pub fn encrypt_button(ui: &mut egui::Ui, cipher: &dyn Cipher, input: &mut String, output: &mut String) {
...
pub fn decrypt_button(ui: &mut egui::Ui, cipher: &dyn Cipher, input: &mut String, output: &mut String) {
