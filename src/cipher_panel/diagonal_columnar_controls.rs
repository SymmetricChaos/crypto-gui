...
use ciphers::transposition::diagonal_columnar::DiagonalColumnar;
use eframe::egui::Ui;
...
pub struct DiagonalColumnarFrame {
    cipher: DiagonalColumnar,
    alphabet_string: String,
    key_string: String,
    example: String,
    example_grid: Grid<Symbol<char>>,
}

impl Default for DiagonalColumnarFrame {
    fn default() -> Self {
        let mut f = Self {
...
impl DiagonalColumnarFrame {
    ...
    fn set_example(&mut self) {
        ...
        self.example_grid = self.cipher.build_grid(n_cols * n_rows);
    }
}

impl CipherFrame for DiagonalColumnarFrame {
    fn ui(&mut self, ui: &mut Ui, _errors: &mut String) {
        ui.hyperlink_to(
            "see the code",
            "https://github.com/SymmetricChaos/crypto-gui/blob/master/ciphers/src/transposition/diagonal_columnar.rs",
        );
        ui.add_space(8.0);
