...
pub struct CipherInterface {
    ...
    homophonic: homophonic_controls::HomophonicFrame,
    ...
    camellia: camellia_controls::CamelliaFrame,
...
impl CipherInterface {
    ...
    pub fn get_active_cipher(&mut self, active_cipher: &CipherId) -> &mut dyn CipherFrame {
        match active_cipher {
            ...
            CipherId::Camellia => &mut self.camellia,
            ...
            CipherId::Homophonic => &mut self.homophonic,
