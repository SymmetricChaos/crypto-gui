...
impl CipherFrame for ChaCha20Poly1305Frame {
    fn ui(&mut self, ui: &mut egui::Ui, _errors: &mut String) {
        ui.hyperlink_to(
            "see the code",
            "https://github.com/SymmetricChaos/crypto-gui/blob/master/ciphers/src/digital/chacha20poly1305.rs",
        );
        ui.add_space(8.0);
        ...
        ui.subheading("Key");
        for i in 0..4 {
            ui.u32_drag_value(&mut self.cipher.cipher.key[i]);
        }
        ui.add_space(8.0);
        ui.subheading("Nonce");
        ...
        for i in 0..3 {
            ui.u32_drag_value(&mut self.cipher.cipher.nonce[i]);
        }

        ui.add_space(8.0);
        ui.subheading("Counter");
        ui.u32_drag_value(&mut self.cipher.cipher.ctr);
