...
use crate::codes::{fibonacci::FibMode, FibonacciCode};
...
impl View for FibonacciCode {
    fn ui(&mut self, ui: &mut eframe::egui::Ui, _errors: &mut String) {
        ui.selectable_value(&mut self.mode, FibMode::Integer, "Integer");
        ui.selectable_value(&mut self.mode, FibMode::Letter, "Letter");
        ui.selectable_value(&mut self.mode, FibMode::Word, "Word");
        ui.add_space(16.0);
