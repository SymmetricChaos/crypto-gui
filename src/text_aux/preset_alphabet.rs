...
pub enum PresetAlphabet {
    ...
    AsciiLhd, // The LHD (letter, digit, hyphen) subset of ASCII used by IDNA
    Greek,
...
impl PresetAlphabet {
    ...
    pub fn slice(&self) -> &'static str {
        match self {
            ...
            PresetAlphabet::AsciiLhd => "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-",
