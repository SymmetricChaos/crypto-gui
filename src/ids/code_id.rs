...
impl CodeID {
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            CodeID::SpellingAlphabet => "Spelling Alphabets or Phonetic Alphabets are designed to spell short sequences of letter over voice channels where noise might caught ambiguity. The earliest formalized spelling alphabet seems to have been issued by Western Union around 1910 but various systems existing prior to that, sometimes focusing only on the most easily confused letters.",
